...
const preview = {
  parameters: {
    ...
    docs: {
      // TOC shows top-level section titles only — including h3s
      // pushed long headings into the narrow rail (single-character
      // wrapping). Salt + Audi both follow this convention.
